...
grid.each_index do |row|
  ...
  grid[row].each_index do |column|
    ...
    products.push( grid[row][column] * 
                   grid[row+1][column] * 
                   grid[row+2][column] * 
                   grid[row+3][column] ) unless row + 3 >= grid.length
    products.push( grid[row][column] * 
                   grid[row][column+1] * 
                   grid[row][column+2] * 
                   grid[row][column+3] ) unless column + 3 >= grid[row].length
    products.push( grid[row][column] * 
                   grid[row+1][column+1] *
                   grid[row+2][column+2] *
                   grid[row+3][column+3] ) unless row + 3 >= grid.length or column + 3 >= grid[row].length
    products.push( grid[row][column] *
                   grid[row-1][column+1] *
                   grid[row-2][column+2] *
                   grid[row-3][column+3] ) unless row - 3 < 0 or column + 3 >= grid[row].length
